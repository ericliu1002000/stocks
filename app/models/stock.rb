class Stock < ActiveRecord::Base
  ...
  def self.update_stock
    ...
    Stock.all.each_with_index  do |stock, i|
      i = i+1
      if str.blank?
        str = "#{stock.city_name}#{code}"
      else
        str = "#{str},#{stock.city_name}#{code}"
      end
      if i%300 == 0
        str = ''
      end
